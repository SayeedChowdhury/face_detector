...
from datasets_xml import load_data
...
#parser.add_argument('-dir', '--data_dir', type=str, default='/local/scratch/a/chowdh23/code/Object-and-Semantic-Part-Detection-pyTorch-master/data/VOCdevkit/VOC2010/')
#parser.add_argument('-dir', '--data_dir', type=str, default='/home/nano01/a/banerj11/srinivg_BackProp_CIFAR10/sayeed/semantic_part_det/data/VOCdevkit/VOC2010/')
#parser.add_argument('-dir', '--data_dir', type=str, default='/home/min/a/chand133/Documents/Face_inpainting/Part_Detector/dataset/')
parser.add_argument('-dir', '--data_dir', type=str, default='/home/nano01/a/chowdh23/Part_Detector/dataset/')


parser.add_argument('-tr', '--train_split', type=str, default='face_train')

parser.add_argument('-val', '--val_split', type=str, default='face_val')

parser.add_argument('-cf', '--class2ind_file', type=str, default='face_semantic_class2ind')
...
model_save_path = 'saved_model_new3_%s_%s.pth' % (TRAIN_SPLIT, N_EPOCHS)
